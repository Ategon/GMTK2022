...
namespace Apdapted.Rendering.Universal.ShaderGUI
{
    public static class LitGUI
    {
        ...
        {
            //Edit
            public static readonly GUIContent ExternalZTest =
                EditorGUIUtility.TrTextContent("External ZTest", "ZTest against _InputDepthTex.");
            //End of Edit
        ...
        {
            //Edit
            public MaterialProperty externalZTest;
            //End of Edit
            ...
            {
                //Edit
                externalZTest = BaseShaderGUI.FindProperty("_ExternalZTest", properties, false);
                //End of Edit
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            //Edit
            if (material.HasProperty("_ExternalZTest"))
            {
                CoreUtils.SetKeyword(material, "_ExternalZTest_ON", material.GetFloat("_ExternalZTest") == 1.0f);
            }
            //End of Edit
